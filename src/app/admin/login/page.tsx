...
import { Lock, Mail, Loader2, ArrowRight } from "lucide-react"; // Pastikan sudah install lucide-react
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Cookies.set("user_role", data.user.role, { expires: 1 }); // Simpan role juga
